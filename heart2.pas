...
procedure TAggExample1.Draw(agg: Agg2D_ptr);
  ...
  begin
    ...
    agg^.resetPath;
    agg^.moveTo(x,  y4);
    agg^.cubicCurveTo(x2, y3, x1, y3, x1, y2);
    agg^.cubicCurveTo(x1, y1, x2, y1, x,  y2);
    agg^.cubicCurveTo(x3, y1, x4, y1, x4, y2);
    agg^.cubicCurveTo(x4, y3, x3, y3, x,  y4);
    agg^.drawPath;
  end;
